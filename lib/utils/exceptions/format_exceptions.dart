...
class KFormatException implements Exception {
  ...
  const KFormatException([this.message = 'An unexpected format error occurred. Please check your input.']);
  ...
  factory KFormatException.fromCode(String code) {
    switch (code) {
      ...
      case 'invalid-credit-card-format':
        return const KFormatException('The credit card format is invalid. Please enter a valid credit card number.');
